...
var LAppWavFileHandler = (function () {
    ...
    LAppWavFileHandler.prototype.start = function (filePath) {
        ...
        if (!this.loadWavFile(filePath)) {
            ...
            console.log(' DELEGATE AHORA VALE => ', lappdelegate_1.LAppDelegate.getInstance());
            console.log('window => ', window.Live2DCubismCore);
