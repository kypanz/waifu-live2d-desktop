    ...
    LAppModel.prototype.update = function () {
        ...
        if (this._lipsync) {
            ...
            for (var i = 0; i < this._lipSyncIds.getSize(); ++i) {
                ...
                this._model.addParameterValueById(this._lipSyncIds.at(i), 0.4, 1);
            }
        }
        if (this._pose != null) {
