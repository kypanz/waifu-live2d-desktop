...
var LAppModel = (function (_super) {
    ...
    LAppModel.prototype.update = function () {
        ...
        if (this._expressionManager != null) {
            ...
            (this._temp_expression) ? this.setExpression(ky_expression[0].first) : this.setExpression(ky_expression[1].first);
