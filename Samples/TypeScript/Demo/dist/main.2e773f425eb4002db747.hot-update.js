...
function runTest(ctx, width, height) {
    try {
        ...
        chat_box.innerHTML = "testing something new ? => ".concat(data_test[random_number].username);
    }
    catch (error) {
