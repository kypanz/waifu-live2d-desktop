...
var LAppModel = (function (_super) {
    ...
    LAppModel.prototype.update = function () {
        ...
        if (this._expressionManager != null) {
            var ky_expression = this._expressions._keyValues[5].first;
