    ...
    LAppModel.prototype.update = function () {
        ...
        if (this._lipsync) {
            ...
            for (var i = 0; i < this._lipSyncIds.getSize(); ++i) {
                ...
                if (test == 1)
                    test = 0;
                this._model.addParameterValueById(this._lipSyncIds.at(i), test, 0.8);
            }
        }
        if (this._pose != null) {
