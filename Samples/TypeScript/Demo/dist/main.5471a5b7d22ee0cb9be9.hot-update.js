...
function runTest(ctx, width, height) {
    try {
        ...
        var radius = 5;
        ctx.globalAlpha = 0.5;
        ctx.roundRect(left, top_1, w, h, radius);
