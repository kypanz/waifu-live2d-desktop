...
function runTest(ctx, width, height) {
    try {
        ...
        ctx.fillText("".concat(data_test[random_number].username), 30, 150);
    }
    catch (error) {
