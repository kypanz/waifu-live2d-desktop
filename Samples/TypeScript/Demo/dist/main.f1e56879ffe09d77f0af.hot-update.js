...
var LAppModel = (function (_super) {
    ...
    LAppModel.prototype.startRandomMotion = function (group, priority, onFinishedMotionHandler) {
        ...
        for (var index = 0; index < this._modelSetting.getMotionCount(group); index++) {
            console.log('Motions => ', this._motions._keyValues[0]);
        }
        var n = 4;
        runTest();
        return this.startMotion(group, n, priority, onFinishedMotionHandler);
    };
