...
var LAppModel = (function (_super) {
    ...
    LAppModel.prototype.startMotion = function (group, no, priority, onFinishedMotionHandler) {
        ...
        var test = true;
        if (test) {
            console.log('Se busco en => ', this._modelSetting);
            var path = voice;
