    ...
    LAppModel.prototype.update = function () {
        ...
        if (this._expressionManager != null) {
            ...
            if (this._temp_expression) {
                ...
                this._expressionManager.updateMotion(this._model, 0.001);
            }
            else {
